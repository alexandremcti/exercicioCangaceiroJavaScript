...
import { Mensagem, MensagemView, NegociacoesView, DateConverter  } from "../ui/index.js";
...
export class NegociacaoController {
    ...
    async adiciona(event) {
        try {
            console.log('adicionando nova negociação');
    ...
    async importaNegociacoes(){
        try {
            ...
            const negociacioes = await service.obterNegociacoesDoPeriodo();
            negociacioes
